...
namespace CrackingCodeInterviewSample.BitManipulation
{
    /*
        ...
        (that is, no byte will be split across rows). The height of the screen, of course, can be derived
        from the length of the array and the width. Implement a function that draws a horizontal line from
        (x1, y) to (x2, y).
    ...
    */
    class DrawLineInMonochromeScreen
    {
